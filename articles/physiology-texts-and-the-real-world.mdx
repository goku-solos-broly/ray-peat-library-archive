...
treatments and "support," the deaths arent counted as accidents. The numbers
are large.
...
books, to signify that the author isnt just a technical hack.

This physiological mythology has made possible a practice of medicine in which
"genes" and "a virus" are regularly invoked to explain things that cant be
...
It was odd and interesting when a vice presidential candidate stepped to the
...
For physiology, the equivalent of medicines "first do no harm" would be
"first, dont believe unfounded doctrines." Accepting that principle puts a
...
think of the cells interior as a watery solution which "fills the space
...
living state. But the living cell isnt like a tiny water-filled test-tube.
...
- **Physiology should be understood in terms of its geochemical setting,**
...
- **An Arrhenius base** is something which produces hydroxide ions when its
dissolved in water.
...
- **Definitions of Arrhenius and Lewis** for acids and bases. Its important to
...
- **Alkali reserve, (Stedmans phrase:) "the basic ions, mainly the
...
- **Electrons, positive charges, electronegativity, and induction:** The unity
...
- **Needs on the cellular level guide the organisms adaptations.**
...
- **Digestion** —bowel and liver; immune system and nervous system; **need** and
...
to do with Guytons unusual personal experience. After graduating from Harvard
...
fairies arent responsible for the Brownian motions seen under a microscope.

The oncotic/osmotic behavior of proteins in the blood and extracellular (the
term **_interstitial_** implies the presence of empty spaces which arent
...
modifying the polymers affinity for water, affect the osmotic behavior of the
polymer, and of gels formed by such polymers. Since the extracellular spaces
are mainly filled with solid gels, Guytons image of simple fluids entering
...
established in Mississippi in 1943. Guytons first paper was on aerosol
...
the public in San Francisco, in 1950. Guytons Harvard colleagues established
a polio research lab at Childrens Hospital Medical Center. When he left the
...
- Acquired traits arent passed on; mutations are random, the genome doesnt
...
- The Donnan equilibrium explains cellular electrical behavior, and since ions
...
- Brain and heart cells dont regenerate.
...
systems and kidneys and membrane pumps and osmoregulation arent discussed in
polite books.)

- During development, cells are organized into systems, and they dont change
...
- The committed nature of the organisms cells and anatomy make radical
...
- Consciousness is produced by nervous signals that transmit information, and
...
I have always felt that the cybernetic definition of communication as the
